        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                child: const Text('Welcome to the Help & Support section of Majadigi Jatim. We’re here to assist you in getting the best experience from the app.', 
              ...
              const SizedBox(height: 12),
              Container(
                child: const Text('If you need further assistance, feel free to reach out:', 
                textAlign: TextAlign.justify,
                style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400)),
              ),
              const SizedBox(height: 12),
              Container(
                child: const Text('   • Email: support@majadigi.jatim.go.id\n'
              ...
              const SizedBox(height: 12),
              Container(
                child: const Text('We aim to respond to all inquiries within 1–2 business days.', 
                textAlign: TextAlign.justify,
                style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400)),
              ),
            ],
